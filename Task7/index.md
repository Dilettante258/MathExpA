...
$$s.\ t.\ \left\\{ \begin{aligned} & 4x_{1} - x_{2} + 2x_{3} - x_{4} = - 2 \\\ & x_{1} + x_{2} + 3x_{3} - x_{4} \leq 14 \\\ & - 2x_{1} + 3x_{2} - x_{3} + 2x_{4} \geq 2 \\\ & x_{1},\ x_{2},\ x_{3} \geq 0,\ \ \ x_{4}无约束.\end{aligned} \right.\ \ \ \ $$
...
$$s.\ t.\ \left\\{ \begin{aligned} & x_{1} + 2x_{2} + x_{3} = 6 \\\ & - 2x_{1} + x_{2} \geq 4 \\\ & 5x_{1} + 3x_{2} \leq 2 \\\ & x_{j} \geq 0,\ \ j = 1,\ 2,\ 3.\end{aligned} \right.\ $$
...
$$s.\ t.\ \left\\{ \begin{aligned} & - x_{1} + 2x_{2} + x_{3} \geq 0 \\\ & x_{1} + 2x_{2} + 2x_{3} \leq 72 \\\ & 10 \leq x_{2} \leq 20 \\\ & x_{1} - x_{2} = 10.\end{aligned} \right.\ $$
...
$$s.\ t.\ \left\\{ \begin{aligned} & - x_{1}^{2} - x_{2}^{2} \leq - 9 \\\ & 2x_{1} + 3x_{2} \leq 2 \\\ & x_{1} - x_{2} \leq 5\end{aligned} \right.\ $$
